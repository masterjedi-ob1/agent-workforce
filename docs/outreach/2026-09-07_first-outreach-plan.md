# First Outreach Plan — Week of 2026-09-07

**Built by:** Buddy · **Partner seat:** Instinct · **Send seat:** Chris (and Chloe where named)
**Evidence:** Deal Touches reports 14 Aug to 27 Aug, audit report 27 Aug, live Gmail sweep 27 Aug to 7 Sep.

## State of the book today
...
| Troveo / Sarah Barrick | Sarah's soft close, Aug 7, unanswered. Fourth consecutive flag. | 31 | COLD, reputational | Answer her. Book 20 minutes or name the month. Silence is the worst option. |
| A2C / Spitzer | Chris → Spitzer, Jul 28. No reply. MNDA open since Jun 26. | 41 | COLD | Close-or-kill: is GaaS on the 2026 roadmap, yes or no. |
| Archway / Huber | No evidence in any system for 60+ days | 60+ | DARK | Reclassify out of Tier 1 unless Chris has an offline channel. |
| CeCe TV / Tara | No evidence in any system for 60+ days | 60+ | DARK | Same. |

Two findings that change the plan:
1. The daily Deal Touches report stopped after Aug 27. The last "healthy" automation is now dead too. Deal Reviver (T1) has no upstream report to read until it is rebuilt or the CRM replaces it.
2. Six of eight deals have had no client-facing message in three weeks. This week is the touch week. Nothing else in the funnel matters until these go out.
...
| Buddy | Instinct |
|---|---|
| Drafts all seven messages in `docs/outreach/drafts/` by Monday 7:00 AM, using thread context from Gmail | Confirms each send in Chris's mailbox and stamps the deal record |
| Rebuilds the Deal Touches report as Deal Reviver's input (T1) | Watches the calendar for the replies that turn into meetings and books them |
| Keeps the live data-flow map and the CRM deal stages current | Reports the Friday scorecard: sent, replied, booked, demoted |

## Success by Friday

- Six client-facing messages sent (NeuralSeek, Troveo, Sunnie, B&K, A2C, PaySitters).
- Two decisions logged (Archway, CeCe TV).
- At least two meetings booked.
- Tier 1 list shrinks to the deals that are real.
